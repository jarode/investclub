                        ...
                        <x-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <!-- Team Settings -->
                                    <x-dropdown-link href="{{ route('teams.show', Auth::check() && Auth::user()->currentTeam ? Auth::user()->currentTeam->id : 1) }}">
                                        {{ __('Team Settings') }}
                                    </x-dropdown-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    ...
                    <!-- Team Settings -->
                    <x-responsive-nav-link href="{{ route('teams.show', Auth::check() && Auth::user()->currentTeam ? Auth::user()->currentTeam->id : 1) }}" :active="request()->routeIs('teams.show')">
                        {{ __('Team Settings') }}
                    </x-responsive-nav-link>
